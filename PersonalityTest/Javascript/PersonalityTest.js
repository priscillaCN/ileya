...
let numberOfAForSectionOne = 0;
let numberOfBForSectionOne = 0;
...
const userResultPerSection = [];

if(numberOfAForSectionOne > numberOfBForSectionOne) userResultPerSection[0] = 'E';
else userResultPerSection[0] = 'I';


const selectedOptionsForSectionTwo = [];
userChoice = "";
count = 0;

let numberOfAForSectionTwo = 0;
let numberOfBForSectionTwo = 0;
...
const selectedOptionsForSectionThree = [];
userChoice = "";
count = 0;

let numberOfAForSectionThree = 0;
let numberOfBForSectionThree = 0;
...
const selectedOptionsForSectionFour = [];
userChoice = "";
count = 0;

let numberOfAForSectionFour = 0;
let numberOfBForSectionFour = 0;
...
for(let selectedOptions of selectedOptionsForSectionOne) {
console.log(selectedOptions);
}

console.log("\nNumber of A seleceted: " + numberOfAForSectionOne);
console.log("Number of B seleceted: " + numberOfBForSectionOne);

console.log("\nSECTION TWO");

for(let selectedOptions of selectedOptionsForSectionTwo) {
console.log(selectedOptions);
}

console.log("\nNumber of A seleceted: " + numberOfAForSectionTwo);
console.log("Number of B seleceted: " + numberOfBForSectionTwo);

console.log("\nSECTION THREE");

for(let selectedOptions of selectedOptionsForSectionThree) {
console.log(selectedOptions);
}
...
for(let selectedOptions of selectedOptionsForSectionFour) {
console.log(selectedOptions);
}

console.log("\nNumber of A seleceted: " + numberOfAForSectionFour);
console.log("Number of B seleceted: " + numberOfBForSectionFour);

let userPersonalityType = userResultPerSection.join('');
...
if(userPersonalityType ===  "INTP")
    console.log(`
        ...
        They are imaginative, creative, and independent thinkers who are compintely unafraid 
...
if(userPersonalityType === "ISTP")
    console.log(`
        ...
        is frequently misinterpreted as bluntness or insensitivity. They compintely reject people-pleasing, which can accidentally alienate or 
...
if(userPersonalityType === "ESFP")
    console.log(`
        ...
        and they consistently transform ordinary get-togethers ino lively celebrations.
